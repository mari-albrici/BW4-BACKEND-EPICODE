...
//		pmd.salvaTratta(tratta1);	
		...
		ParcoMezzi mezzo1 = new ParcoMezzi(stato_parcoMezzi.servizio, 75, trattaUno,
				LocalDateTime.of(2023, 05, 23, 10, 26), LocalDateTime.of(2023, 05, 23, 12, 26), 2, 1,
				TipoDiMezzo.Autobus);
...
//		pvd.save(pvendita1);
		...
		ParcoMezzi mezzoUno = pmd.getMezzo("25cc1870-5a2f-4523-9687-f84cb53da8af");

		Biglietto biglietto1 = new Biglietto(LocalDate.of(2023, 05, 23), true, pvendita1, true, mezzoUno,
